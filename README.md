...
│ └──📃index.js // 라우터
├──📃.gitignore // Git 관리
├──📃jsconfig.json // Front 프로젝트 기본 설정
└──📃package.json // 패키지 의존성 관리
└──📃package-lock.json // 패키지 의존성 관리
└──📃README.md // 리액트 기존 README
```
...
└──📃OurolaApplication.java // 백엔드 시작

// auth 파일을 제외한 나머지 파일엔 CSR 존재
```
