...
CREATE TABLE IF NOT EXISTS `ourola`.`artist_user` (
  ...
  `resign` TINYINT(1) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ourola`.`bill` (
  ...
  `is_membership` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `ourola`.`fan_feed`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ourola`.`fan_feed` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `group_id` INT NULL DEFAULT NULL,
  `user_id` INT NULL DEFAULT NULL,
  `artist_id` INT NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `FK_group_channel_TO_fan_feed_1` (`group_id` ASC) VISIBLE,
  INDEX `FK_fan_user_TO_fan_feed_1` (`user_id` ASC) VISIBLE,
  INDEX `FK_artist_user_TO_fan_feed_1` (`artist_id` ASC) VISIBLE,
  CONSTRAINT `FK_artist_user_TO_fan_feed_1`
    FOREIGN KEY (`artist_id`)
    REFERENCES `ourola`.`artist_user` (`id`),
  CONSTRAINT `FK_fan_user_TO_fan_feed_1`
    FOREIGN KEY (`user_id`)
    REFERENCES `ourola`.`fan_user` (`id`),
  CONSTRAINT `FK_group_channel_TO_fan_feed_1`
    FOREIGN KEY (`group_id`)
    REFERENCES `ourola`.`group_channel` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `ourola`.`bookmark` (
  ...
  INDEX `FK_fan_feed_TO_bookmark_1` (`feed_id` ASC) VISIBLE,
  CONSTRAINT `FK_fan_feed_TO_bookmark_1`
    FOREIGN KEY (`feed_id`)
    REFERENCES `ourola`.`fan_feed` (`id`),
...
CREATE TABLE IF NOT EXISTS `ourola`.`comment` (
  ...
  INDEX `FK_fan_feed_TO_comment_1` (`feed_id` ASC) VISIBLE,
  CONSTRAINT `FK_artist_user_TO_comment_1`
    FOREIGN KEY (`artist_id`)
    REFERENCES `ourola`.`artist_user` (`id`),
  CONSTRAINT `FK_fan_feed_TO_comment_1`
    FOREIGN KEY (`feed_id`)
    REFERENCES `ourola`.`fan_feed` (`id`),
...
CREATE TABLE IF NOT EXISTS `ourola`.`file` (
  ...
  `file_extension` VARCHAR(10) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `FK_fan_feed_TO_file_1` (`feed_id` ASC) VISIBLE,
  CONSTRAINT `FK_fan_feed_TO_file_1`
    FOREIGN KEY (`feed_id`)
    REFERENCES `ourola`.`fan_feed` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `ourola`.`like` (
  ...
  `user_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`like_id`),
  INDEX `FK_fan_feed_TO_like_1` (`feed_id` ASC) VISIBLE,
  INDEX `FK_fan_user_TO_like_1` (`user_id` ASC) VISIBLE,
  CONSTRAINT `FK_fan_feed_TO_like_1`
    FOREIGN KEY (`feed_id`)
    REFERENCES `ourola`.`fan_feed` (`id`),
...
CREATE TABLE IF NOT EXISTS `ourola`.`notification` (
  ...
  INDEX `FK_fan_feed_TO_notification_1` (`feed_id` ASC) VISIBLE,
  CONSTRAINT `FK_fan_feed_TO_notification_1`
    FOREIGN KEY (`feed_id`)
    REFERENCES `ourola`.`fan_feed` (`id`),
