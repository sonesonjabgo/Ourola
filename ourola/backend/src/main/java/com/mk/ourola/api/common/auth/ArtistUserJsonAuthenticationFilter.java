...
public class ArtistUserJsonAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	public ArtistUserJsonAuthenticationFilter(ObjectMapper objectMapper) {
