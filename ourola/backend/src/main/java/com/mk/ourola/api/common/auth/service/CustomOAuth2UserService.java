...
import com.mk.ourola.api.common.auth.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
	 ...
	 */
	private FanDto saveUser(OAuthAttributes attributes, SocialType socialType) {
		FanDto createdUser = attributes.toEntity(socialType, attributes.getOauth2UserInfo());
		return fanRepository.save(createdUser);
	}
}
